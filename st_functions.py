...
def st_button(icon, url, label, iconsize):
    if icon == 'twitter':
        button_code = f'''
        <p>      
        <a href={url} class="btn btn-secondary" aria-pressed="true">
        ...
        <div class="btn-group">
        <p>
        <a href={url} class="btn btn-secondary" type="button" aria-pressed="true">
        ...
        button_code = f'''
        <p class= "btn-group btn-group-toggle">
