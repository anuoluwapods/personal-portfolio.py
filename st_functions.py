...
def st_button(icon, url, label, iconsize):
    if icon == 'twitter':
        button_code = f'''
        <p>
        <a href={url} class="btn btn-secondary" role="group" type="button" aria-pressed="true">
        ...
        button_code = f'''
        <p>
        <a href={url} div class= "btn-group btn-group-toggle" class="btn btn-secondary active" type="button" aria-pressed="true">
