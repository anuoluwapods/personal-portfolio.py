...
def st_button(icon, url, label, iconsize):
    if icon == 'github':
        button_code = f'''
        <p>
            <a href={url} class="btn-group btn-group-toggle" type="button" aria-pressed="true">
        ...
        button_code = f'''
        <p>
        <a href={url} class="btn btn-secondary btn-lg btn-block" type="button" aria-pressed="true">
        ...
        button_code = f'''
        <p>
        <a href={url} class="btn btn-secondary btn-sm" type="button" aria-pressed="true">
